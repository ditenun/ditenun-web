...
num_channel =1
names = ['Ulos Mangiring', 'Ulos Ragi Hidup', 'Ulos Sitolutuho','Ulos Ragi Hotang', 'Ulos Harungguan', 'Ulos Sibolang', 'Ulos Bintang Maratur', 'Ulos Sadum']
img_rows=900
img_cols=900
