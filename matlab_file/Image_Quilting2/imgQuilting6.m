function imgQuilting6 = example(SourceFile, newFileName, matrix, warna)
    %  SourceFile = 'E:\GenerateMotifMatlab\motif\3856.png';
    %  newFileName= 'E:\GenerateMotifMatlab\motif\baru6.png';
    %  matrix = 4;
    %  warna = 4;
      ...
      if(modulus==0 && inputan >=2)
          ...
          while i <= 1
              ...
              while j <= 2
                  ...
                  imgFullAsli = x;
                  %imwrite(uint8(imgFullAsli),strcat(int2str(cek),newFileName,'(FullGabungan).jpg'),'jpg');
                  ...
                  %imwrite(uint8(newii),strcat(newFileName,'name.png'),'jpg');
